...
BOOL SelectSource( LPRefObj pRefObj, ULONG *pulSrcID )
{
	...
	wSel = 1; //la id del dipositivo siempre se encuentra en el 1, porque no soportamos mas de 1 dispostivo Nikon conectado a la vez. 

	if ( wSel <= stEnum.ulElements ) {
...
char* GetEnumString( ULONG ulCapID, ULONG ulValue, char *psString )
{
	switch ( ulCapID ) {
		...
		case kNkMAIDCapability_Active_D_Lighting:
			switch( ulValue )
			{
				case 0: 
		...
		case kNkMAIDCapability_AutoDistortion:
			switch( ulValue )
			{
				case 0: 
					strcpy( psString, "Off" );
		...
		case kNkMAIDCapability_ImageColorSpace:
			switch( ulValue )
			{
				case 0: 
					strcpy( psString, "sRGB" );
					break;
				case 1: 
					strcpy( psString, "AdobeRGB" );
					break;
			}
			break;

		case kNkMAIDCapability_HDRMode:
			switch( ulValue )
			{
				case 0: 
					strcpy( psString, "Off" );
		...
		case kNkMAIDCapability_AFAreaPoint:
			switch( ulValue )
			{
				case 1: 
					strcpy( psString, "11 points" );
					break;
				case 2: 
					strcpy( psString, "39 points" );
					break;
			}
			break;
		...
		case kNkMAIDCapability_MeteringMode:
			switch( ulValue ){
				...
				case kNkMAIDMeteringMode_Spot:
					...
					break;
				default:
					sprintf( psString, "MeteringModGete %u", ulValue );
			}
			break;
        ...
        case kNkMAIDCapability_AFMode:
			switch( ulValue ){
				...
				case 2:
					...
					break;
				case 3:
					strcpy( psString, "MF Fixed" );
					break;
				case 4:
					strcpy( psString, "MF Selected" );
					break;
				default:
					sprintf( psString, "FocusMode %u", ulValue );
			}
...
//------------------------------------------------------------------------------------------------------------------------------------
//MODIFIED: Format changed to user preference
char*	GetUnsignedString( ULONG ulCapID, ULONG ulValue, char *psString )
{
	...
	case kNkMAIDCapability_Active_D_Lighting:
		sprintf( buff, "%2d. High\n", 0);
		strcpy( psString, buff );
		sprintf( buff, "%2d. Normal\n", 1);
		strcat( psString, buff );
		sprintf( buff, "%2d. Low\n", 2);
		strcat( psString, buff );
		sprintf( buff, "%2d. Off\n", 3);
		strcat( psString, buff );
		sprintf( buff, "%2d. Extra high\n", 5);
		strcat( psString, buff );
		sprintf( buff, "%2d. Auto\n", 6);
		strcat( psString, buff );
		break;
	...
	case kNkMAIDCapability_ImageColorSpace:
		sprintf( buff, "%2d. sRGB\n", 0);
		strcpy( psString, buff );
		sprintf( buff, "%2d. AdobeRGB\n", 1);
		strcat( psString, buff );
		break;
	...
	case kNkMAIDCapability_AFAreaPoint:
		sprintf( buff, "%2d. 11 points\n", 1);
		strcpy( psString, buff );
		sprintf( buff, "%2d. 39 points\n", 2);
		strcat( psString, buff );
		break;
	case kNkMAIDCapability_MeteringMode:
		sprintf( buff, "%2d. Matrix\n", kNkMAIDMeteringMode_Matrix );
		strcpy( psString, buff );
		sprintf( buff, "%2d. CenterWeighted\n", kNkMAIDMeteringMode_CenterWeighted );
		strcat( psString, buff );
		sprintf( buff, "%2d. Spot\n", kNkMAIDMeteringMode_Spot );
		strcat( psString, buff );
		break;
	case kNkMAIDCapability_FocusMode:
		sprintf( buff, "%2d. MF\n", kNkMAIDFocusMode_MF );
		strcpy( psString, buff );
		sprintf( buff, "%2d. AF-S\n", kNkMAIDFocusMode_AFs );
		strcat( psString, buff );
		sprintf( buff, "%2d. AF-C\n", kNkMAIDFocusMode_AFc );		
		strcat( psString, buff );
		sprintf( buff, "%2d. AF-A\n", kNkMAIDFocusMode_AFa );		
		strcat( psString, buff );
		sprintf( buff, "%2d. AF-F\n", kNkMAIDFocusMode_AFf );
		strcat( psString, buff );
		break;
	...
	case kNkMAIDCapability_WBFluorescentType:
		sprintf( buff, "%2d. Sodium-vapor lamps\n", kNkWBFluorescentType_SodiumVapor );
		strcpy( psString, buff );
		sprintf( buff, "%2d. Warm-white fluorescent\n", kNkWBFluorescentType_WarmWhite );
		strcat( psString, buff );
		sprintf( buff, "%2d. White fluorescent\n", kNkWBFluorescentType_White );
		strcat( psString, buff );
		sprintf( buff, "%2d. Cool-white fluorescent\n", kNkWBFluorescentType_CoolWhite );
		strcat( psString, buff );
		sprintf( buff, "%2d. Day white fluorescent\n", kNkWBFluorescentType_DayWhite );
		strcat( psString, buff );
		sprintf( buff, "%2d. Daylight fluorescent\n", kNkWBFluorescentType_Daylight );
		strcat( psString, buff );
		sprintf( buff, "%2d. High temp. mercury-vapor\n", kNkWBFluorescentType_HiTempMercuryVapor );
		strcat( psString, buff );
		break;
...
BOOL SetEnumCapability( LPRefObj pRefObj, ULONG ulCapID, int value, bool set, char* ATTRIBUTE_INFO)
{
	BOOL	bRet;
	NkMAIDEnum	stEnum;
	...
	switch ( stEnum.ulType ) {
		case kNkMAIDArrayType_Unsigned:
			return SetEnumUnsignedCapability( pRefObj, ulCapID, &stEnum, value, set, ATTRIBUTE_INFO);
			break;
		case kNkMAIDArrayType_PackedString:
			return SetEnumPackedStringCapability( pRefObj, ulCapID, &stEnum, value, set, ATTRIBUTE_INFO);
			break;
		case kNkMAIDArrayType_String:
			return SetEnumStringCapability( pRefObj, ulCapID, &stEnum, value, set, ATTRIBUTE_INFO);
			break;
		default:
			return false;
	}
...
BOOL SetEnumUnsignedCapability( LPRefObj pRefObj, ULONG ulCapID, LPNkMAIDEnum pstEnum, int value, bool set, char* ATTRIBUTE_INFO)
{
	BOOL	bRet;
	char	psString[32];
	UWORD	wSel;
	...
	{           
		...
		//printf( "There is no element in this attribute.\n>" );
		return true;
	}
	...
	if (set)
    {
		if (CheckCapabilityOperation(pRefObj, ulCapID, kNkMAIDCapOperation_Set))
		{
            ...
            */
			...
			//strcpy(ATTRIBUTE_INFO,"This value cannot be changed. Check if the camera is in Manual mode.\n>");
		}
	}
	else
	{
		for (i = 0; i < pstEnum->ulValue; i++);
		sprintf(ATTRIBUTE_INFO, "%s", GetEnumString(ulCapID, ((ULONG*)pstEnum->pData)[i], psString));
	}
...
BOOL SetEnumPackedStringCapability( LPRefObj pRefObj, ULONG ulCapID, LPNkMAIDEnum pstEnum, int value, bool set, char* ATTRIBUTE_INFO)
{
	BOOL	bRet;
	char	*psStr;
	UWORD	wSel;
	ULONG	i = 0, n, ulCount = 0;
	LPNkMAIDCapInfo pCapInfo = GetCapInfo( pRefObj, ulCapID );
	if ( pCapInfo == NULL ) return false;
	...
	*/
	...
	if (set){
		...
		{
			// This capablity is read-only.
			strcpy(ATTRIBUTE_INFO,"Check if the camera is in Manual mode.\n>");
		}
	}
	else
	{
...
BOOL SetEnumStringCapability( LPRefObj pRefObj, ULONG ulCapID, LPNkMAIDEnum pstEnum, int value, bool set, char* ATTRIBUTE_INFO)
{
	BOOL	bRet;
	char	buf[256];
	UWORD	wSel;
	...
	{
		// This capablity has no element and is not available.
		//printf( "There is no element in this capability.\n>" );
		return true;
	}
	...
	if (set){
		if (CheckCapabilityOperation(pRefObj, ulCapID, kNkMAIDCapOperation_Set)) {
			...
			sprintf(ATTRIBUTE_INFO, "UserInput: %d, RealValue:Empty", pstEnum->ulValue + 1);
		}
		else {
			// This capablity is read-only.
			//printf("This value cannot be changed.\n>");
		}
	}
	else
	{
...
BOOL	GetRangeEnumCapability(LPRefObj pRefObj, ULONG ulCapID, char* rangeInfo)
/*
Puts all the possible values in to the matrix pointed by rangeInfo
*/
{
	BOOL	bRet;
	NkMAIDEnum	stEnum;
	...
	switch (stEnum.ulType) {
	case kNkMAIDArrayType_Unsigned:
		return GetRangeEnumUnsignedCapability(pRefObj, ulCapID, &stEnum,rangeInfo);
		break;
	case kNkMAIDArrayType_PackedString:
		return GetRangeEnumPackedStringCapability(pRefObj, ulCapID, &stEnum,rangeInfo);
		break;
	case kNkMAIDArrayType_String:
		return GetRangeEnumStringCapability(pRefObj, ulCapID, &stEnum,rangeInfo);
		break;
	default:
		return false;
	}
...
BOOL GetRangeRangeCapability(LPRefObj pRefObj, ULONG ulCapID, char* rangeInfo)
{
	BOOL bRet;
	LPNkMAIDCapInfo pCapInfo = GetCapInfo(pRefObj, ulCapID);
	NkMAIDRange	stRange;
	...
	switch(ulCapID)
	{
		case  kNkMAIDCapability_ExposureComp:
		case  kNkMAIDCapability_InternalFlashComp:
			sprintf(rangeInfo, "\n[%s]\nMinimum Value: %.2f - Maximum Value: %.2f\n", pCapInfo->szDescription, stRange.lfLower, stRange.lfUpper);
			bRet= true;
			break;
		default:
			bRet= false;
...
BOOL	GetRangeEnumUnsignedCapability(LPRefObj pRefObj, ULONG ulCapID, LPNkMAIDEnum pstEnum, char* rangeInfo)
{
	BOOL	bRet;
	char	psString[32];
	UWORD	wSel;
...
BOOL	GetRangeEnumPackedStringCapability(LPRefObj pRefObj, ULONG ulCapID, LPNkMAIDEnum pstEnum, char* rangeInfo)
{
	BOOL	bRet;
	char	*psStr;
	UWORD	wSel;
	ULONG	i, n=0, ulCount = 0;
	LPNkMAIDCapInfo pCapInfo = GetCapInfo(pRefObj, ulCapID);
	if (pCapInfo == NULL) return false;
...
BOOL	GetRangeEnumStringCapability(LPRefObj pRefObj, ULONG ulCapID, LPNkMAIDEnum pstEnum, char* rangeInfo)
{
	/*
	INCOMPLETE. 
	*/
...
BOOL GetRangeBoolCapability(LPRefObj pRefObj, ULONG ulCapID, char* rangeInfo)
{
	LPNkMAIDCapInfo pCapInfo = GetCapInfo(pRefObj, ulCapID);
	sprintf(rangeInfo, "\n[%s]\nUserInput. RealValue\n", pCapInfo->szDescription);
	switch (ulCapID)
	{
		...
		case kNkMAIDCapability_AfSubLight:
			strcat(rangeInfo,"1.On\n2.Off\n");	
			break;
		case kNkMAIDCapability_EnableBracketing:
			strcat(rangeInfo,"1.Used\n2.Not Used\n");
			break;
		default: 
			strcat(rangeInfo, "Attribute not recognized.");
	}
	return true;
}
...
BOOL SetIntegerCapability( LPRefObj pRefObj, ULONG ulCapID, char* ATTRIBUTE_INFO)
{
	BOOL	bRet;
	SLONG	lValue;
	char	buf[256];
	...
	// show current value of this capability
	sprintf(ATTRIBUTE_INFO, "UserInput: %ld", lValue);
...
BOOL SetUnsignedCapability( LPRefObj pRefObj, ULONG ulCapID, int value, bool set, char* AttributeInfo)
{
	BOOL	bRet;
	ULONG	ulValue;
	char	buf[256];
	...
	if (set){
		if ( CheckCapabilityOperation( pRefObj, ulCapID, kNkMAIDCapOperation_Set ) ) {
			...
			sprintf(AttributeInfo, "%s", GetEnumString(ulCapID,ulValue,psString));
			if( bRet == false ) return false;

		}
		else {
			// This capablity is read-only.
			strcpy(AttributeInfo, "This value cannot be changed. Check if the Camera is set in manual mode.");
		}
	}
	else 
	{
...
BOOL	GetRangeUnsignedCapability(LPRefObj pRefObj, ULONG ulCapID, char* rangeInfo)
{
	BOOL	bRet;
	ULONG	ulValue;
	char	buf[256];
	...
	char tmp[300];
	sprintf(rangeInfo, "\n[%s]\nUserInput. RealValue\n", pCapInfo->szDescription);
	sprintf(tmp,"%s", GetUnsignedString(ulCapID, ulValue, buf));
	strcat(rangeInfo, tmp);
	return true;
}
//------------------------------------------------------------------------------------------------------------------------------------
...
BOOL SetSizeCapability(LPRefObj pRefObj, ULONG ulCapID, NkMAIDSize*	stSize)
{
	BOOL	bRet;
	char	buf[256];
	LPNkMAIDCapInfo pCapInfo = GetCapInfo( pRefObj, ulCapID );
...
BOOL SetBoolCapability( LPRefObj pRefObj, ULONG ulCapID, int value, bool set, char* AttributeInfo)
{
	BOOL	bRet;
	BYTE	bFlag;
	char	buf[256];
	...
	else
	{
		...
		switch (ulCapID)
		{
			case kNkMAIDCapability_IsoControl:
			case kNkMAIDCapability_AfSubLight:
				sprintf(AttributeInfo,"%s",bFlag ? "On" : "Off");	
				break;
			case kNkMAIDCapability_EnableBracketing:
				sprintf(AttributeInfo, "%s", bFlag ? "Used" : "Not Used");
				break;
			default: 
				sprintf(AttributeInfo, "Attribute not recognized.");
		}
...
BOOL SetRangeCapability( LPRefObj pRefObj, ULONG ulCapID, double value, bool set, char* AttributeInfo)
{
	BOOL	bRet;
	NkMAIDRange	stRange;
	double	lfValue;
	...
	if (set){
		...
		{
			strcpy(AttributeInfo, "This attribute can not be modified.");
		}
	}
	else
	{
