...
//compile this file on matlab doing: mex mex_readNef.cpp libraw/libraw.lib. The resulting mex should be used along with the libraw dll, which is already compiled. 
