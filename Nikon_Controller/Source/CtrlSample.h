...
BOOL	GetRangeEnumCapability(LPRefObj pRefObj, ULONG ulCapID,  char* rangeInfo);//custom
BOOL	GetRangeEnumUnsignedCapability(LPRefObj pRefObj, ULONG ulCapID, LPNkMAIDEnum pstEnum, char* rangeInfo);//custom
BOOL	GetRangeEnumPackedStringCapability(LPRefObj pRefObj, ULONG ulCapID, LPNkMAIDEnum pstEnum, char* rangeInfo);//custom
BOOL	GetRangeEnumStringCapability(LPRefObj pRefObj, ULONG ulCapID, LPNkMAIDEnum pstEnum, char* rangeInfo);//custom
BOOL 	GetRangeBoolCapability(LPRefObj pRefObj, ULONG ulCapID, char* rangeInfo);//custom
...
BOOL	SetUnsignedCapability( LPRefObj pRefObj, ULONG ulCapID, int value, bool set, char* Attribute_Info);
BOOL	GetRangeUnsignedCapability(LPRefObj pRefObj, ULONG ulCapID, char* rangeInfo); //Custom
